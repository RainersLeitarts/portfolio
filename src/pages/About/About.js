        ...
        <div className='about-wrapper' id='about'>
            <div className='about-col1'>
                <div className='about-content-wrapper'>
                    ...
                    Since then I have worked on a couple 
                    ...
                    , from all of which I learned a lot. I am driven to learn and expand my skill set to become a better developer.</p>
                    <div className='about-socials-container'>
                        <span>Find me on: </span>
                        <a href='https://www.linkedin.com/in/rainers-leitarts/' rel="noreferrer" target='_blank'>
                            <img className='about-socials-icon' alt='' src={linkedin_img} />
                        </a>
                        <a href='https://github.com/RainersLeitarts' rel="noreferrer" target='_blank'>
